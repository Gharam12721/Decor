      ...
      appBar: new AppBar(
        ...
        title: Row(
          ...
          children: [
            Text(
              "Categories",
              style: TextStyle(color: Color(0xff070707),fontSize: 30,fontWeight: FontWeight.bold),
            ),
            IconButton(
                ...
                child: Row(
                  ...
                  children: [
                    TextButton(
                      ...
                      child:Row(
                        children: [
                            Image(image: AssetImage('image/icon-03.png'),
                              height: 30,
                            ),
                            Text("Price Range"),
                        ]
                        ...
                        children: [
                           ...
                           elevation:3,
                            child:TextButton(
                              child:Stack(
                                ...
                                Image(image: AssetImage('image/photo3.jpeg'),
                                height: 220,
                                  fit: BoxFit.cover,
                                ),
                                ...
                                Image(image:AssetImage('image/icon-02.png'),
                                    height: 40,
                                  ),
                              ]
                            ),
                          ...
                          Card(
                            ...
                            child:TextButton(
                              child:Stack(
                                children:[
                                  Image(image: AssetImage('image/chair3.jpg'),
                                    height: 220,
                                    fit: BoxFit.cover,
                                  ),
                                  Positioned(bottom: 10,
                                ...
                                onPressed: (){
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => ShowScreen3()));})
                      ),]
                      ),
                      Column(
                        children:[
                            ...
                            //padding: EdgeInsets.only(bottom: 15),
                              child:TextButton(
                               child:Stack(
                                  children:[
                                    Image(image: AssetImage('image/photo2.jpg'),
                                      height: 220,
                                      fit: BoxFit.cover,
                                    ),
                                    Positioned(bottom: 10,
                                  ...
                                  onPressed: (){
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => ShowScreen2()));})
                            ),
                            Card(
                              elevation:3,
                              child:TextButton(
                                child:Stack(
                                  children:[
                                    Image(image: AssetImage('image/tablle3.jpg'),
                                      height: 220,
                                      fit: BoxFit.cover,
                                    ),
                                    Positioned(bottom: 10,
                                  ...
                                  onPressed: (){
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => ShowScreen4()));})
                            )
                          ],
                      )
                  ],
