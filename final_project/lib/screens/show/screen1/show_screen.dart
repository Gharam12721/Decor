                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                "Chairs",
                                  style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,letterSpacing: 1,color: Colors.black),
                               ),
                              Text(
                                "Chairs",
                        ...
                        children: [
                          Column(
                            children: [
                              Text(
                                'Quantity',
                                  style:TextStyle(fontSize: 18, color: Colors.deepPurple.shade200),
                                ),
                              Row(
                                children: [
                                  RawMaterialButton(
                                ...
                                Text('$q' , style: TextStyle(fontSize: 19 , color: Colors.deepPurple.shade200 ),),
                              RawMaterialButton(
                                onPressed: () {
                                  setState(() {
                                      q++;
